...
--adaptive_stddev=False --with_vtrace=False --max_policy_lag=100000000 --rnn_size=128 \
...
--quads_neighbor_hidden_size=128 --quads_neighbor_obs_type=pos_vel --quads_collision_hitbox_radius=2.0 \
...
--experiment=mean_embed_16_8_relu